...
- `captureTraceNotify`: set to `1` to notify suspected sign/task/energy request URLs for tracing
...
- `captureTraceNotify`：设为 `1` 后，疑似签到/任务/积分接口命中时会通知 URL，便于定位真实签到接口
...
1. Make sure the plugin is updated to `v=20260716c`.
