...
```text
https://raw.githubusercontent.com/gougedeyebaihe-hub/gouge/main/lynkco-share.remote.plugin?v=20260812n
```

当前脚本缓存版本：

```text
auto.bundle.js?v=20260812n
```
